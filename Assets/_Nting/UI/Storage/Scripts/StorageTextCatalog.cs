...
namespace Nting.Storage
{
    ...
    public static class StorageTextCatalog
    {
        ...
        private static readonly Dictionary<StorageTextId, Entry> Entries = new Dictionary<StorageTextId, Entry>
        {
            { StorageTextId.WindowEyebrow, new Entry("物品储存", "Item Storage") },
            { StorageTextId.WindowTitle, new Entry("储物空间", "Storage") },
            { StorageTextId.WindowHint, new Entry("拖拽物品 / 右键旋转 / 双击转移 / 拖出容器可放到地上 / Esc关闭", "Drag items / right click rotate / double click transfer / drag out to drop / Esc closes") },
            { StorageTextId.PlayerWindowHint, new Entry("拖拽物品 / 右键旋转 / 双击转移 / 从手部格使用 / Esc关闭", "Drag items / right click rotate / double click transfer / use from hand slots / Esc closes") },
