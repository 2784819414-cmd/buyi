...
namespace Nting.Storage
{
    public enum StorageItemLegalState
    {
        ...
        Personal = 1,
        Public = 2,
        PendingProtectedTransfer = 3,
        // Legacy alias kept for old saves, prefabs, and mods.
        // Normal gameplay code should use PendingProtectedTransfer.
        Suspicious = PendingProtectedTransfer,
        Stolen = 4,
        EvidenceDestroyed = 5
    }
